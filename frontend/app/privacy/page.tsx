      ...
      <main className="prv-main" ref={mainRef}>
        <div className="prv-wrap">
          <div className="prv-hero">
            <div>
              <span className="prv-hero-label">Legal</span>
              <h1 className="prv-hero-title">Privacy Notice</h1>
              ...
              <div className="prv-hero-meta">
                ...
                <span className="prv-meta-chip">NDPR compliant</span>
              </div>
            </div>
          </div>
          ...
          <div className="prv-content-area">
            ...
            <div className="prv-sections">
              {SECTIONS.map((section) => (
                <div key={section.number} className="prv-section">
                  <h2 className="prv-section-title">
                    <span className="prv-section-num">{section.number}.</span> {section.title}
                  </h2>
                  <div className="prv-section-body">{section.content}</div>
                </div>
              ))}
            </div>
